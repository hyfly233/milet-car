...
public class OrderController {
    ...
    @Autowired
    private ServiceForecastWithoutEureka ServiceForecastWithoutEureka;


    @PostMapping("/forecast")
    public ResponseResult<ForecastResponse> forecast(@RequestBody ForecastRequest forecastRequest) {

        ResponseResult<ForecastResponse> result = ServiceForecastWithoutEureka.forecast(forecastRequest);
